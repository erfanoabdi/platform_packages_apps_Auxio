...
public final class ItemSongBinding implements ViewBinding {
  ...
  private ItemSongBinding(@NonNull ConstraintLayout rootView, @NonNull ImageGroup songAlbumCover,
      @NonNull TextView songInfo, @NonNull TextView songName) {
  ...
  public static ItemSongBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      ImageGroup songAlbumCover = ViewBindings.findChildViewById(rootView, id);
      ...
      return new ItemSongBinding((ConstraintLayout) rootView, songAlbumCover, songInfo, songName);
    }
